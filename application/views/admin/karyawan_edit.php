...
<body>
    ...
    <div id="appCapsule">
        <div class="section full mt-2">
            <div class="section-title">Edit Data Karyawan</div>
            ...
            <div class="wide-block pb-1 pt-1">
                ...
                <form method="POST" action="<?= base_url('karyawan/edit/') . $data->kode_karyawan ?>">
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            <label class="label" for="name5">Kode Karyawan</label>
                            <input type="text" class="form-control bg-secondary" placeholder="Kode Inisial" disabled="" value="<?= $data->kode_karyawan ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="nm" class="form-control" placeholder="Nama Karyawan" value="<?= $data->nama_karyawan ?>">
                        </div>
                    </div>
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            <label class="label" for="name5">Hp</label>
                            <input type="text" name="hp" class="form-control" placeholder="Nomor Hp" value="<?= $data->hp ?>">
                        </div>
                    </div>
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            <label class="label" for="name5">Alamat</label>
                            <input type="text" name="alm" class="form-control" placeholder="Alamat Karyawan" value="<?= $data->alamat ?>">
                        </div>
                    </div>
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            <label class="label" for="name5">Keterangan</label>
                            <input type="text" name="ket" class="form-control" placeholder="Keterangan" value="<?= $data->ket ?>">
                            </i>
                        </div>
                    </div>
                    <div class="form-group boxed">
