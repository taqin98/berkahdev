...
<body>
    ...
    <div id="appCapsule">
        ...
        <div class="section full mt-2">
            <div class="section-title" style="display: inline-flex;">Daftar Karyawan
                <a href="<?= base_url('karyawan/create') ?>" class="btn btn-success btn-sm ml-3">
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th scope="col text-center">Ket</th>
                        ...
                        <?php
                            ...
                            <tr>
                                ...
                                <td scope="row"><?= $key->kode_karyawan; ?></td>
                                <td scope="row"><?= $key->nama_karyawan; ?></td>
                                <td scope="row"><?= $key->hp; ?></td>
                                <td scope="row"><?= $key->alamat; ?></td>
                                <td scope="row"><?= $key->ket; ?></td>
                                <td scope="row"><a href="<?= base_url('karyawan/edit/') . $key->kode_karyawan ?>" class="btn btn-warning btn-sm">
                                    <img src="<?= base_url('assets/icons/pencil-square.svg') ?>" alt="Bootstrap" width="20" height="20" class="m-1">
                                Edit</a></td>
                                <td scope="row"><a href="<?= base_url('karyawan/delete/') . $key->kode_karyawan ?>" class="btn btn-danger btn-sm">
