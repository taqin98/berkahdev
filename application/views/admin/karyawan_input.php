...
<body>
    ...
    <div id="appCapsule">
        <div class="section full mt-2">
            <div class="section-title">Input Data Karyawan</div>
            ...
            <div class="wide-block pb-1 pt-1">
                ...
                <form method="POST" action="<?= base_url('karyawan/create') ?>">
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            <label class="label" for="name5">Kode Karyawan</label>
                            <input type="text" class="form-control" placeholder="Kode Inisial" name="kode_kar" required="">
                        </div>
                    </div>
                    ...
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="nm" class="form-control" placeholder="Nama Karyawan">
                        </div>
                    </div>
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                    ...
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="alm" class="form-control" placeholder="Alamat Karyawan">
                        </div>
                    </div>
                    <div class="form-group boxed">
                        <div class="input-wrapper">
