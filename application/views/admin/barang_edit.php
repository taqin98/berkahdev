...
<body>
    ...
    <div id="appCapsule">
        <div class="section full mt-2">
            <div class="section-title">Edit Data Barang</div>
            ...
            <div class="wide-block pb-1 pt-1">
                ...
                <form method="POST" action="<?= base_url('barang/edit/') . $data->kode_brg ?>">
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            <label class="label" for="name5">Kode Karyawan</label>
                            <input type="text" class="form-control disabled" readonly="" placeholder="Kode Brg" name="kode_brg" required="" value="<?= $data->kode_brg ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="nm" class="form-control" placeholder="Nama Brg" value="<?= $data->nama_brg ?>">
                        </div>
                    </div>
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            <label class="label" for="name5">Harga Pcs</label>
                            <input type="text" name="hrg" class="form-control" placeholder="Harga Brg" value="<?= $data->harga_pcs ?>">
                        </div>
                    </div>
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            <label class="label" for="name5">Stok</label>
                            <input type="number" name="stok" class="form-control" placeholder="Stok Brg" value="<?= $data->stok ?>">
                        </div>
                    </div>
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            <label class="label" for="name5">Komisi (K)</label>
                            <input type="number" name="kredit" class="form-control" placeholder="Komisi kredit" value="<?= $data->komisi_kredit ?>">
                        </div>
                    </div>
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            <label class="label" for="name5">Komisi (C)</label>
                            <input type="number" name="cash" class="form-control" placeholder="Komisi Cash" value="<?= $data->komisi_cash ?>">
                        </div>
                    </div>
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            <label class="label" for="name5">Hrg (K)</label>
                            <input type="number" name="hrg_k" class="form-control" placeholder="Komisi kredit" value="<?= $data->hrg_kredit ?>">
                        </div>
                    </div>
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            <label class="label" for="name5">Hrg (C)</label>
                            <input type="number" name="hrg_c" class="form-control" placeholder="Komisi Cash" value="<?= $data->hrg_cash ?>">
                        </div>
                    </div>
                    <div class="form-group boxed">
                        <div class="input-wrapper">
